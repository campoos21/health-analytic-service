...
class TestRecordIngest:
    ...
    def test_create_record_full_payload(self, client, auth_headers, sample_record_payload):
    ...
    def test_create_record_minimal(self, client, auth_headers, db):
    ...
    def test_missing_record_id(self, client, auth_headers, db):
    ...
    def test_upsert_same_record_id(self, client, auth_headers, db):
    ...
    def test_partial_upsert_preserves_fields(self, client, auth_headers, db):
    ...
    def test_patient_get_or_create(self, client, auth_headers, db):
    ...
    def test_record_without_patient(self, client, auth_headers, db):
