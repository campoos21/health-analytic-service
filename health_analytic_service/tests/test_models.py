...
class TestApiKeyModel:
    ...
    def test_generate_api_key_returns_hex(self):
...
class TestPatientModel:
    ...
    def test_create_patient_minimal(self, db):
    ...
    def test_create_patient_full(self, db):
    ...
    def test_patient_id_unique(self, db):
...
class TestRecordModel:
    ...
    def test_create_record_minimal(self, db):
    ...
    def test_create_record_full(self, sample_patient):
    ...
    def test_record_id_unique(self, db):
        """Duplicate record_id values must be rejected."""
        Record.objects.create(record_id="REC-DUP")
        with pytest.raises(IntegrityError):
            Record.objects.create(record_id="REC-DUP")

    def test_fk_set_null_on_patient_delete(self, sample_patient):
